...
function drawButton(btnInfo) {
  ...
  btn.mousePressed(() => {
    console.log("🔘 click en botón:", btnInfo.position);
    console.log("📍 antes - mode:", mode, "paused:", paused, "running:", running);
    btnInfo.action();
    console.log("📍 después - mode:", mode, "paused:", paused, "running:", running);
  });
  return btn;
}
